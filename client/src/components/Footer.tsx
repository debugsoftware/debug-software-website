      ...
      <div className="container py-14 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-6">
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-sm text-white/35 leading-relaxed max-w-[280px]">
              Soluções em Inteligência Artificial e automações inteligentes para empresas
              que precisam escalar com eficiência.
            </p>
          </div>
        ...
        <div className="mt-12 pt-6 border-t border-white/[0.04] flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/25">
            &copy; {currentYear} Debug Software LTDA. Todos os direitos reservados.
          </p>
          <p className="text-xs text-white/25">
